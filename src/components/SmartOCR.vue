          ...
          <b-row>
            ...
            <b-col>
              ...
              <div class="container">
                ...
                <div class="row">
                  <div class="col-sm text-right">
                    Size of the identified grid:
                  </div>
                  <div class="col-sm text-left font-weight-bold">
                    {{ocrresult.size_of_identified_grid}}
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm text-right">
                    Size of Grid in metadata:
                  </div>
                  <div class="col-sm text-left font-weight-bold">
                    {{ocrresult.size_of_grid_in_metadata}}
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm text-right">
                    Match between SLD Grid and Observed Grid:
                  </div>
                  <div class="col-sm text-left font-weight-bold">
                    {{ocrresult.match_between_sld_grid_and_observed_grid}}
                  </div>
                </div>
				<div class="row">
                  <div class="col-sm text-right">
                    Match between Sheath and Singtel owned Duct:
                  </div>
                  <div class="col-sm text-left font-weight-bold">
                    {{ocrresult.match_between_sheath_and_singtel_owned_duct}}
                  </div>
                </div>
				<div class="row">
                  <div class="col-sm text-right">
                    The new cable (sheath) passess through Duct:
                  </div>
                  <div class="col-sm text-left font-weight-bold">
                    {{ocrresult.the_new_cable_passess_through_Duct}}
                  </div>
                </div>
              </div>
...
const AWS_PUBSUB_ENDPOINT = 'wss://a2ygn6fwtwjn8o.iot.us-east-1.amazonaws.com/mqtt'
...
export default {
  ...
  methods: {
    ...
    uploadSuccess: async function (putresult) {
      ...
      this.uploadresult.s3objectkey=this.uploadresult.s3objectkey.replace(".JPG","_result.jpg")
